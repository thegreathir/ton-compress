...
class BinaryFrequencyTable final : public FrequencyTable {
	...
	const static std::uint32_t TOTAL = (1 << 30);

	/*---- Fields ----*/
	
	// (Probability of the bit being 0) / TOTAL.
	public: std::uint32_t p;
	
	
	/*---- Constructor ----*/
	
	// Constructs a flat frequency table with the given number of symbols.
	public: explicit BinaryFrequencyTable();
